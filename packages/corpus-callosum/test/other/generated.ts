...
namespace Args {
	...
	export type _5FeetApartCuzTheyreNotGayGet = ExtractArgs<Models._5FeetApartCuzTheyreNotGayGet>;
	...
	export type OrgsOrgIdMembersMemberIdPut = ExtractArgs<Models.OrgsOrgIdMembersMemberIdPut>;
	export type OrgsOrgIdMembersMemberIdDelete = ExtractArgs<Models.OrgsOrgIdMembersMemberIdDelete>;
}
...
class CorpusApi {
	...
	public orgsOrgIdMembersMemberIdPut = (args: Args.OrgsOrgIdMembersMemberIdPut) => {
		const req = {
