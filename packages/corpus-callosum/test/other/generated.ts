...
) => ({ endpoint: "/chillin/in/a/hottub", method: "GET", search: args.search });
...
class CorpusApi {
	...
	helloParam1Param2Get = (args: ExtractArgs<HelloParam1Param2GetModel>) =>
		this.fetchFn<HelloParam1Param2GetModel["response"]>(
			makeHelloParam1Param2GetRequest(args),
		);
	worldParam1Param2Get = (args: ExtractArgs<WorldParam1Param2GetModel>) =>
		this.fetchFn<WorldParam1Param2GetModel["response"]>(
			makeWorldParam1Param2GetRequest(args),
		);
	lalalaParam1Param2Get = (args: ExtractArgs<LalalaParam1Param2GetModel>) =>
		this.fetchFn<LalalaParam1Param2GetModel["response"]>(
			makeLalalaParam1Param2GetRequest(args),
		);
	yesyesParam2Get = (args: ExtractArgs<YesyesParam2GetModel>) =>
		this.fetchFn<YesyesParam2GetModel["response"]>(
			makeYesyesParam2GetRequest(args),
		);
	okayParam1LetsgoGet = (args: ExtractArgs<OkayParam1LetsgoGetModel>) =>
		this.fetchFn<OkayParam1LetsgoGetModel["response"]>(
			makeOkayParam1LetsgoGetRequest(args),
		);
	denemeParam1Param2Get = (args: ExtractArgs<DenemeParam1Param2GetModel>) =>
		this.fetchFn<DenemeParam1Param2GetModel["response"]>(
			makeDenemeParam1Param2GetRequest(args),
		);
	weGotThisGet = (args: ExtractArgs<WeGotThisGetModel>) =>
		this.fetchFn<WeGotThisGetModel["response"]>(makeWeGotThisGetRequest(args));
	ohmyohmyGet = (args: ExtractArgs<OhmyohmyGetModel>) =>
		this.fetchFn<OhmyohmyGetModel["response"]>(makeOhmyohmyGetRequest(args));
	_2brosGet = (args: ExtractArgs<_2brosGetModel>) =>
		this.fetchFn<_2brosGetModel["response"]>(make_2brosGetRequest(args));
	chillinInAHottubGet = (args: ExtractArgs<ChillinInAHottubGetModel>) =>
		this.fetchFn<ChillinInAHottubGetModel["response"]>(
			makeChillinInAHottubGetRequest(args),
		);
	_5FeetApartCuzTheyreNotGayGet = (
		args: ExtractArgs<_5FeetApartCuzTheyreNotGayGetModel>,
	) =>
		this.fetchFn<_5FeetApartCuzTheyreNotGayGetModel["response"]>(
			make_5FeetApartCuzTheyreNotGayGetRequest(args),
		);
	verywild_Get = (args: ExtractArgs<Verywild_GetModel>) =>
		this.fetchFn<Verywild_GetModel["response"]>(makeVerywild_GetRequest(args));
	craaaazy_Get = (args: ExtractArgs<Craaaazy_GetModel>) =>
		this.fetchFn<Craaaazy_GetModel["response"]>(makeCraaaazy_GetRequest(args));
	usersPost = (args: ExtractArgs<UsersPostModel>) =>
		this.fetchFn<UsersPostModel["response"]>(makeUsersPostRequest(args));
	usersGet = (args: ExtractArgs<UsersGetModel>) =>
		this.fetchFn<UsersGetModel["response"]>(makeUsersGetRequest(args));
	usersIdGet = (args: ExtractArgs<UsersIdGetModel>) =>
		this.fetchFn<UsersIdGetModel["response"]>(makeUsersIdGetRequest(args));
	usersIdPut = (args: ExtractArgs<UsersIdPutModel>) =>
		this.fetchFn<UsersIdPutModel["response"]>(makeUsersIdPutRequest(args));
	usersIdDelete = (args: ExtractArgs<UsersIdDeleteModel>) =>
		this.fetchFn<UsersIdDeleteModel["response"]>(
			makeUsersIdDeleteRequest(args),
		);
	usersIdPostsPost = (args: ExtractArgs<UsersIdPostsPostModel>) =>
		this.fetchFn<UsersIdPostsPostModel["response"]>(
			makeUsersIdPostsPostRequest(args),
		);
	orgsPost = (args: ExtractArgs<OrgsPostModel>) =>
		this.fetchFn<OrgsPostModel["response"]>(makeOrgsPostRequest(args));
	orgsOrgIdMembersGet = (args: ExtractArgs<OrgsOrgIdMembersGetModel>) =>
		this.fetchFn<OrgsOrgIdMembersGetModel["response"]>(
			makeOrgsOrgIdMembersGetRequest(args),
		);
	orgsOrgIdMembersMemberIdPut = (
		args: ExtractArgs<OrgsOrgIdMembersMemberIdPutModel>,
	) =>
		this.fetchFn<OrgsOrgIdMembersMemberIdPutModel["response"]>(
			makeOrgsOrgIdMembersMemberIdPutRequest(args),
		);
	orgsOrgIdMembersMemberIdDelete = (
		args: ExtractArgs<OrgsOrgIdMembersMemberIdDeleteModel>,
	) =>
		this.fetchFn<OrgsOrgIdMembersMemberIdDeleteModel["response"]>(
