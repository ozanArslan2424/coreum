...
export interface NoValidationModel {
	// No validation library detected.
	 ...
	 list: { search: { page?: string, limit?: string }, response: [NoValidationModel["entity"]] };
	 create: { body: { name: string }, response: NoValidationModel["entity"] };
	 update: { params: NoValidationModel["get"]["params"], body: { name: string }, response: NoValidationModel["entity"] };
